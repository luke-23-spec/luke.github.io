    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class=" font-weight-bold m-1 text-lg text-primary">Product category</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link y" href="#" data-target="#keyboard" data-toggle="tab">Syrup</a>
                                  <style>
                                  .y:hover {
                                    font-weight: bold;
                                    color: red;
                              ...
                              <li class="nav-item">
                                <a class="nav-link y" href="#" data-target="#mouse" data-toggle="tab">Tablet</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#headset" data-toggle="tab">Capsule</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#cpu" data-toggle="tab">Topical Medicine</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#monitor" data-toggle="tab">Implants</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#motherboard" data-toggle="tab">Injection</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#processor" data-toggle="tab">Inhaler</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#powersupply" data-toggle="tab">Drops</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link y" href="#others" data-toggle="tab">Suppositories</a>
                              </li>
                            </ul>
        ...
        <tr>  
          <td>
           ...
           <td>
            ...
            KES <?php echo number_format($product['quantity'] * $product['price'], 2); ?></td>  
           <td>
