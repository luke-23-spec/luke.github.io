...
?>
            ...
            <div class="form-group row text-left mb-0 py-2">
                ...
                <div class="col-sm-4 py-1">
                  <h4>
                    Cash Amount: KES <?php echo number_format($cash, 2); ?>
                  </h4>
                  <table width="100%">
                    <tr>
                      <td class="font-weight-bold">Subtotal</td>
                      <td class="text-right">KES <?php echo $sub; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Less VAT</td>
                      <td class="text-right">KES <?php echo $less; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Net of VAT</td>
                      <td class="text-right">KES <?php echo $net; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Add VAT</td>
                      <td class="text-right">KES <?php echo $add; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Total</td>
                      <td class="font-weight-bold text-right text-primary">KES <?php echo $grand; ?></td>
                    </tr>
                  </table>
                </div>
