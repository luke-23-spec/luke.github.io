...
<body style="background-size: cover;" background="../img/bg.jpg" class="we bg-gradiet-primary">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          ...
          .r{
    background: linear-gradient(54deg, #003eff, #ffffff, #000000, #02ff00);
...
@keyframes AnimationName {
    ...
    100%{background-position:0% 50%}
                  ...
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Palmer Pharmacy Management System</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="r btn btn-primary btn-user btn-block" type="submit" name="btnlogin">Login</button>
                    <hr>
                  <!-- <div class="text-center">
